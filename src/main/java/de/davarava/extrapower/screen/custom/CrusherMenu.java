...
public class CrusherMenu extends AbstractContainerMenu {
    ...
    public CrusherMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0, 44, 35));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 1, 80, 35) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
        });
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 2, 98, 35) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
